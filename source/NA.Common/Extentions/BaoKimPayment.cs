 ...
 */
    public class BaoKimPayment
    {
        ...
        private string baokim_url_base = "https://www.baokim.vn";
        //Mã merchant site
         ...
         * @return url cần tạo
         */
        public String createRequestUrl(String order_id, String business, String total_amount, String shipping_fee, String tax_fee, String order_description, String url_success, String url_cancel, String url_detail, string email, string name, string phone, string address)
        {
            ...
            order_params.Add("payer_email", email);
            order_params.Add("payer_name", name);
            order_params.Add("payer_phone_no", phone);
            order_params.Add("shipping_address", address);
        ...
        public string getUrlBaoKim()
        {
            return this.baokim_url_base;
        }
    }
}